        ...
        if(response.object==null){
            ...
            switch(response.message) {
                ...
                case '2':
                  ...
                  break;
                default:
                    alert("Please contact webmaster, message = response.object==null " + response.message);
            }
        }else{
            if(response.object.roles[0].id == 1) {
                sessionStorage.setItem("login", JSON.stringify(response));
                window.location.replace("/manager/home/home.html");
            }else{
                response.object.roles[0].id = "Student";
                sessionStorage.setItem("login", JSON.stringify(response));
                getUserInfo(email);
            }
...
function showUser(){
    ...
    if(obj && obj.message=="1"){
        ...
        + "</a> / " + obj.object.roles[0].id + " &nbsp;&nbsp; " + obj.object.username;
